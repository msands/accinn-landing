          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="flex flex-col h-full items-center">
              ...
              <CardContent className="flex-1 flex flex-col justify-between w-full items-center">
                ...
                <div className="mt-auto w-full">
                  <Link href="/contact?inquiry=Enterprise%20Demo%20Request">
                    <Button className="bg-amber-700 hover:bg-amber-800 text-white font-bold w-full">
            ...
            <Card className="flex flex-col h-full items-center">
              ...
              <CardContent className="flex-1 flex flex-col justify-between w-full items-center">
                ...
                <div className="mt-auto w-full">
                  <Link href="/contact?inquiry=Institutional%20Information%20Request">
                    <Button className="bg-amber-700 hover:bg-amber-800 text-white font-bold w-full">
